...
__asm("GLOBAL nosup@@$_$_" "IDLOC7" "\nnosup@@$_$_" "IDLOC7" " SET 0");
# 85 "main.c"
...
float read_battery_voltage()
{
    ...
    return ( 15.0 * convertedValue/1024.0);
}
...
enum event_list get_event()
{
    ...
    else
    {
        ...
        if (PTT_current_value != PORTAbits.RA4)
        {
            newevent=1;
...
int main(void)
{
    ...
    PTT_current_value = PORTAbits.RA4;

    while( (PTT_current_value=PORTAbits.RA4)==0);
# 297 "main.c"
